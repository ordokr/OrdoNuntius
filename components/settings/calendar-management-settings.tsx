...
// CalendarColorPicker + CALENDAR_COLORS live in their own tiny module so
// the eager calendar-sidebar-panel doesn't have to pull this entire
// 766-line settings file (plus ShareCollectionDialog / ICalImportModal /
// ICalSubscriptionModal / calendar-store) into the calendar route's
// boot bundle.
import { CalendarColorPicker, CALENDAR_COLORS } from '@/components/calendar/calendar-color-picker';
