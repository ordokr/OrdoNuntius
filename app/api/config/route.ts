...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    faviconUrl: configManager.get<string>('faviconUrl', '/branding/OrdoNuntius_Favicon.svg'),
    appLogoLightUrl: configManager.get<string>('appLogoLightUrl', ''),
    appLogoDarkUrl: configManager.get<string>('appLogoDarkUrl', ''),
    loginLogoLightUrl: configManager.get<string>('loginLogoLightUrl', '/branding/OrdoNuntius_Logo_Color.svg'),
    loginLogoDarkUrl: configManager.get<string>('loginLogoDarkUrl', '/branding/OrdoNuntius_Logo_White.svg'),
